      ...
      <div>
        ...
        <div className="container">
          ...
          <div className="lastFetched" id="left">
            {/* !!!!!Change the plant.EC to the name of the actual value passed in the json object */}
          <p>Last Fetched at: {showTime} - {plant.EC}</p>
          {/* {data.map((item) => ( <div key={item.id}>{item.name}</div> ))} */}
               {/* {data.map((item) => (<div key={item.id}>{item.EC}</div>))} */}
        ...
        <div className="graph">
              <p>Graph:</p>
              <Chart dataKey="EC" yAxisLabel="EC" />
          </div>
          </div>
    </div>  
);
